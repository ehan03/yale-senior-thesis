...
SELECT t1.id,
    ...
    SQRT(t2.avg_r1_total_strikes_accuracy * t3.avg_r1_opp_total_strikes_accuracy) - SQRT(t3.avg_r1_total_strikes_accuracy * t2.avg_r1_opp_total_strikes_accuracy) AS expected_avg_r1_total_strikes_accuracy_diff,
    ...
    SQRT(t2.cumulative_r1_total_strikes_accuracy * t3.cumulative_r1_opp_total_strikes_accuracy) - SQRT(t3.cumulative_r1_total_strikes_accuracy * t2.cumulative_r1_opp_total_strikes_accuracy) AS expected_cumulative_r1_total_strikes_accuracy_diff,
    ...
    SQRT(t2.avg_r1_significant_strikes_accuracy * t3.avg_r1_opp_significant_strikes_accuracy) - SQRT(t3.avg_r1_significant_strikes_accuracy * t2.avg_r1_opp_significant_strikes_accuracy) AS expected_avg_r1_significant_strikes_accuracy_diff,
    ...
    SQRT(t2.cumulative_r1_significant_strikes_accuracy * t3.cumulative_r1_opp_significant_strikes_accuracy) - SQRT(t3.cumulative_r1_significant_strikes_accuracy * t2.cumulative_r1_opp_significant_strikes_accuracy) AS expected_cumulative_r1_significant_strikes_accuracy_diff,
    ...
    SQRT(t2.avg_r1_significant_strikes_head_accuracy * t3.avg_r1_opp_significant_strikes_head_accuracy) - SQRT(t3.avg_r1_significant_strikes_head_accuracy * t2.avg_r1_opp_significant_strikes_head_accuracy) AS expected_avg_r1_significant_strikes_head_accuracy_diff,
    ...
    SQRT(t2.cumulative_r1_significant_strikes_head_accuracy * t3.cumulative_r1_opp_significant_strikes_head_accuracy) - SQRT(t3.cumulative_r1_significant_strikes_head_accuracy * t2.cumulative_r1_opp_significant_strikes_head_accuracy) AS expected_cumulative_r1_significant_strikes_head_accuracy_diff,
    ...
    SQRT(t2.avg_r1_significant_strikes_body_accuracy * t3.avg_r1_opp_significant_strikes_body_accuracy) - SQRT(t3.avg_r1_significant_strikes_body_accuracy * t2.avg_r1_opp_significant_strikes_body_accuracy) AS expected_avg_r1_significant_strikes_body_accuracy_diff,
    ...
    SQRT(t2.cumulative_r1_significant_strikes_body_accuracy * t3.cumulative_r1_opp_significant_strikes_body_accuracy) - SQRT(t3.cumulative_r1_significant_strikes_body_accuracy * t2.cumulative_r1_opp_significant_strikes_body_accuracy) AS expected_cumulative_r1_significant_strikes_body_accuracy_diff,
    ...
    SQRT(t2.avg_r1_significant_strikes_leg_accuracy * t3.avg_r1_opp_significant_strikes_leg_accuracy) - SQRT(t3.avg_r1_significant_strikes_leg_accuracy * t2.avg_r1_opp_significant_strikes_leg_accuracy) AS expected_avg_r1_significant_strikes_leg_accuracy_diff,
    ...
    SQRT(t2.cumulative_r1_significant_strikes_leg_accuracy * t3.cumulative_r1_opp_significant_strikes_leg_accuracy) - SQRT(t3.cumulative_r1_significant_strikes_leg_accuracy * t2.cumulative_r1_opp_significant_strikes_leg_accuracy) AS expected_cumulative_r1_significant_strikes_leg_accuracy_diff,
    ...
    SQRT(t2.avg_r1_significant_strikes_distance_accuracy * t3.avg_r1_opp_significant_strikes_distance_accuracy) - SQRT(t3.avg_r1_significant_strikes_distance_accuracy * t2.avg_r1_opp_significant_strikes_distance_accuracy) AS expected_avg_r1_significant_strikes_distance_accuracy_diff,
    ...
    SQRT(t2.cumulative_r1_significant_strikes_distance_accuracy * t3.cumulative_r1_opp_significant_strikes_distance_accuracy) - SQRT(t3.cumulative_r1_significant_strikes_distance_accuracy * t2.cumulative_r1_opp_significant_strikes_distance_accuracy) AS expected_cumulative_r1_significant_strikes_distance_accuracy_diff,
    ...
    SQRT(t2.avg_r1_significant_strikes_clinch_accuracy * t3.avg_r1_opp_significant_strikes_clinch_accuracy) - SQRT(t3.avg_r1_significant_strikes_clinch_accuracy * t2.avg_r1_opp_significant_strikes_clinch_accuracy) AS expected_avg_r1_significant_strikes_clinch_accuracy_diff,
    ...
    SQRT(t2.cumulative_r1_significant_strikes_clinch_accuracy * t3.cumulative_r1_opp_significant_strikes_clinch_accuracy) - SQRT(t3.cumulative_r1_significant_strikes_clinch_accuracy * t2.cumulative_r1_opp_significant_strikes_clinch_accuracy) AS expected_cumulative_r1_significant_strikes_clinch_accuracy_diff,
    ...
    SQRT(t2.avg_r1_significant_strikes_ground_accuracy * t3.avg_r1_opp_significant_strikes_ground_accuracy) - SQRT(t3.avg_r1_significant_strikes_ground_accuracy * t2.avg_r1_opp_significant_strikes_ground_accuracy) AS expected_avg_r1_significant_strikes_ground_accuracy_diff,
    ...
    SQRT(t2.cumulative_r1_significant_strikes_ground_accuracy * t3.cumulative_r1_opp_significant_strikes_ground_accuracy) - SQRT(t3.cumulative_r1_significant_strikes_ground_accuracy * t2.cumulative_r1_opp_significant_strikes_ground_accuracy) AS expected_cumulative_r1_significant_strikes_ground_accuracy_diff,
    ...
    SQRT(t2.avg_r1_takedowns_accuracy * t3.avg_r1_opp_takedowns_accuracy) - SQRT(t3.avg_r1_takedowns_accuracy * t2.avg_r1_opp_takedowns_accuracy) AS expected_avg_r1_takedowns_accuracy_diff,
    t2.cumulative_r1_takedowns_accuracy - t3.cumulative_r1_takedowns_accuracy AS cumulative_r1_takedowns_accuracy_diff,
    SQRT(t2.cumulative_r1_takedowns_accuracy * t3.cumulative_r1_opp_takedowns_accuracy) - SQRT(t3.cumulative_r1_takedowns_accuracy * t2.cumulative_r1_opp_takedowns_accuracy) AS expected_cumulative_r1_takedowns_accuracy_diff,
