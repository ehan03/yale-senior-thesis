...
SELECT
    ...
    SQRT(t2.avg_total_strikes_accuracy * t3.avg_opp_total_strikes_accuracy) - SQRT(t3.avg_total_strikes_accuracy * t2.avg_opp_total_strikes_accuracy) AS expected_avg_total_strikes_accuracy_diff,
    t2.cumulative_total_strikes_accuracy - t3.cumulative_total_strikes_accuracy AS cumulative_total_strikes_accuracy_diff,
    SQRT(t2.cumulative_total_strikes_accuracy * t3.cumulative_opp_total_strikes_accuracy) - SQRT(t3.cumulative_total_strikes_accuracy * t2.cumulative_opp_total_strikes_accuracy) AS expected_cumulative_total_strikes_accuracy_diff,
    ...
    SQRT(t2.avg_significant_strikes_accuracy * t3.avg_opp_significant_strikes_accuracy) - SQRT(t3.avg_significant_strikes_accuracy * t2.avg_opp_significant_strikes_accuracy) AS expected_avg_significant_strikes_accuracy_diff,
    ...
    SQRT(t2.cumulative_significant_strikes_accuracy * t3.cumulative_opp_significant_strikes_accuracy) - SQRT(t3.cumulative_significant_strikes_accuracy * t2.cumulative_opp_significant_strikes_accuracy) AS expected_cumulative_significant_strikes_accuracy_diff,    
    ...
    SQRT(t2.avg_significant_strikes_head_accuracy * t3.avg_opp_significant_strikes_head_accuracy) - SQRT(t3.avg_significant_strikes_head_accuracy * t2.avg_opp_significant_strikes_head_accuracy) AS expected_avg_significant_strikes_head_accuracy_diff,
    ...
    SQRT(t2.cumulative_significant_strikes_head_accuracy * t3.cumulative_opp_significant_strikes_head_accuracy) - SQRT(t3.cumulative_significant_strikes_head_accuracy * t2.cumulative_opp_significant_strikes_head_accuracy) AS expected_cumulative_significant_strikes_head_accuracy_diff,        
    ...
    SQRT(t2.avg_significant_strikes_body_accuracy * t3.avg_opp_significant_strikes_body_accuracy) - SQRT(t3.avg_significant_strikes_body_accuracy * t2.avg_opp_significant_strikes_body_accuracy) AS expected_avg_significant_strikes_body_accuracy_diff,    
    ...
    SQRT(t2.cumulative_significant_strikes_body_accuracy * t3.cumulative_opp_significant_strikes_body_accuracy) - SQRT(t3.cumulative_significant_strikes_body_accuracy * t2.cumulative_opp_significant_strikes_body_accuracy) AS expected_cumulative_significant_strikes_body_accuracy_diff,        
    ...
    SQRT(t2.avg_significant_strikes_leg_accuracy * t3.avg_opp_significant_strikes_leg_accuracy) - SQRT(t3.avg_significant_strikes_leg_accuracy * t2.avg_opp_significant_strikes_leg_accuracy) AS expected_avg_significant_strikes_leg_accuracy_diff,    
    ...
    SQRT(t2.cumulative_significant_strikes_leg_accuracy * t3.cumulative_opp_significant_strikes_leg_accuracy) - SQRT(t3.cumulative_significant_strikes_leg_accuracy * t2.cumulative_opp_significant_strikes_leg_accuracy) AS expected_cumulative_significant_strikes_leg_accuracy_diff,        
    ...
    SQRT(t2.avg_significant_strikes_distance_accuracy * t3.avg_opp_significant_strikes_distance_accuracy) - SQRT(t3.avg_significant_strikes_distance_accuracy * t2.avg_opp_significant_strikes_distance_accuracy) AS expected_avg_significant_strikes_distance_accuracy_diff,    
    ...
    SQRT(t2.cumulative_significant_strikes_distance_accuracy * t3.cumulative_opp_significant_strikes_distance_accuracy) - SQRT(t3.cumulative_significant_strikes_distance_accuracy * t2.cumulative_opp_significant_strikes_distance_accuracy) AS expected_cumulative_significant_strikes_distance_accuracy_diff,        
    ...
    SQRT(t2.avg_significant_strikes_clinch_accuracy * t3.avg_opp_significant_strikes_clinch_accuracy) - SQRT(t3.avg_significant_strikes_clinch_accuracy * t2.avg_opp_significant_strikes_clinch_accuracy) AS expected_avg_significant_strikes_clinch_accuracy_diff,    
    ...
    SQRT(t2.cumulative_significant_strikes_clinch_accuracy * t3.cumulative_opp_significant_strikes_clinch_accuracy) - SQRT(t3.cumulative_significant_strikes_clinch_accuracy * t2.cumulative_opp_significant_strikes_clinch_accuracy) AS expected_cumulative_significant_strikes_clinch_accuracy_diff,        
    ...
    SQRT(t2.avg_significant_strikes_ground_accuracy * t3.avg_opp_significant_strikes_ground_accuracy) - SQRT(t3.avg_significant_strikes_ground_accuracy * t2.avg_opp_significant_strikes_ground_accuracy) AS expected_avg_significant_strikes_ground_accuracy_diff,    
    ...
    SQRT(t2.cumulative_significant_strikes_ground_accuracy * t3.cumulative_opp_significant_strikes_ground_accuracy) - SQRT(t3.cumulative_significant_strikes_ground_accuracy * t2.cumulative_opp_significant_strikes_ground_accuracy) AS expected_cumulative_significant_strikes_ground_accuracy_diff,        
    ...
    SQRT(t2.avg_significant_strikes_distance_head_accuracy * t3.avg_opp_significant_strikes_distance_head_accuracy) - SQRT(t3.avg_significant_strikes_distance_head_accuracy * t2.avg_opp_significant_strikes_distance_head_accuracy) AS expected_avg_significant_strikes_distance_head_accuracy_diff,    
    ...
    SQRT(t2.cumulative_significant_strikes_distance_head_accuracy * t3.cumulative_opp_significant_strikes_distance_head_accuracy) - SQRT(t3.cumulative_significant_strikes_distance_head_accuracy * t2.cumulative_opp_significant_strikes_distance_head_accuracy) AS expected_cumulative_significant_strikes_distance_head_accuracy_diff,        
    ...
    SQRT(t2.avg_significant_strikes_distance_body_accuracy * t3.avg_opp_significant_strikes_distance_body_accuracy) - SQRT(t3.avg_significant_strikes_distance_body_accuracy * t2.avg_opp_significant_strikes_distance_body_accuracy) AS expected_avg_significant_strikes_distance_body_accuracy_diff,    
    ...
    SQRT(t2.cumulative_significant_strikes_distance_body_accuracy * t3.cumulative_opp_significant_strikes_distance_body_accuracy) - SQRT(t3.cumulative_significant_strikes_distance_body_accuracy * t2.cumulative_opp_significant_strikes_distance_body_accuracy) AS expected_cumulative_significant_strikes_distance_body_accuracy_diff,        
    ...
    SQRT(t2.avg_significant_strikes_distance_leg_accuracy * t3.avg_opp_significant_strikes_distance_leg_accuracy) - SQRT(t3.avg_significant_strikes_distance_leg_accuracy * t2.avg_opp_significant_strikes_distance_leg_accuracy) AS expected_avg_significant_strikes_distance_leg_accuracy_diff,    
    ...
    SQRT(t2.cumulative_significant_strikes_distance_leg_accuracy * t3.cumulative_opp_significant_strikes_distance_leg_accuracy) - SQRT(t3.cumulative_significant_strikes_distance_leg_accuracy * t2.cumulative_opp_significant_strikes_distance_leg_accuracy) AS expected_cumulative_significant_strikes_distance_leg_accuracy_diff,        
    ...
    SQRT(t2.avg_significant_strikes_clinch_head_accuracy * t3.avg_opp_significant_strikes_clinch_head_accuracy) - SQRT(t3.avg_significant_strikes_clinch_head_accuracy * t2.avg_opp_significant_strikes_clinch_head_accuracy) AS expected_avg_significant_strikes_clinch_head_accuracy_diff,    
    ...
    SQRT(t2.cumulative_significant_strikes_clinch_head_accuracy * t3.cumulative_opp_significant_strikes_clinch_head_accuracy) - SQRT(t3.cumulative_significant_strikes_clinch_head_accuracy * t2.cumulative_opp_significant_strikes_clinch_head_accuracy) AS expected_cumulative_significant_strikes_clinch_head_accuracy_diff,        
    ...
    SQRT(t2.avg_significant_strikes_clinch_body_accuracy * t3.avg_opp_significant_strikes_clinch_body_accuracy) - SQRT(t3.avg_significant_strikes_clinch_body_accuracy * t2.avg_opp_significant_strikes_clinch_body_accuracy) AS expected_avg_significant_strikes_clinch_body_accuracy_diff,    
    ...
    SQRT(t2.cumulative_significant_strikes_clinch_body_accuracy * t3.cumulative_opp_significant_strikes_clinch_body_accuracy) - SQRT(t3.cumulative_significant_strikes_clinch_body_accuracy * t2.cumulative_opp_significant_strikes_clinch_body_accuracy) AS expected_cumulative_significant_strikes_clinch_body_accuracy_diff,        
    ...
    SQRT(t2.avg_significant_strikes_clinch_leg_accuracy * t3.avg_opp_significant_strikes_clinch_leg_accuracy) - SQRT(t3.avg_significant_strikes_clinch_leg_accuracy * t2.avg_opp_significant_strikes_clinch_leg_accuracy) AS expected_avg_significant_strikes_clinch_leg_accuracy_diff,    
    ...
    SQRT(t2.cumulative_significant_strikes_clinch_leg_accuracy * t3.cumulative_opp_significant_strikes_clinch_leg_accuracy) - SQRT(t3.cumulative_significant_strikes_clinch_leg_accuracy * t2.cumulative_opp_significant_strikes_clinch_leg_accuracy) AS expected_cumulative_significant_strikes_clinch_leg_accuracy_diff,        
    ...
    SQRT(t2.avg_significant_strikes_ground_head_accuracy * t3.avg_opp_significant_strikes_ground_head_accuracy) - SQRT(t3.avg_significant_strikes_ground_head_accuracy * t2.avg_opp_significant_strikes_ground_head_accuracy) AS expected_avg_significant_strikes_ground_head_accuracy_diff,    
    ...
    SQRT(t2.cumulative_significant_strikes_ground_head_accuracy * t3.cumulative_opp_significant_strikes_ground_head_accuracy) - SQRT(t3.cumulative_significant_strikes_ground_head_accuracy * t2.cumulative_opp_significant_strikes_ground_head_accuracy) AS expected_cumulative_significant_strikes_ground_head_accuracy_diff,        
    ...
    SQRT(t2.avg_significant_strikes_ground_body_accuracy * t3.avg_opp_significant_strikes_ground_body_accuracy) - SQRT(t3.avg_significant_strikes_ground_body_accuracy * t2.avg_opp_significant_strikes_ground_body_accuracy) AS expected_avg_significant_strikes_ground_body_accuracy_diff,    
    ...
    SQRT(t2.cumulative_significant_strikes_ground_body_accuracy * t3.cumulative_opp_significant_strikes_ground_body_accuracy) - SQRT(t3.cumulative_significant_strikes_ground_body_accuracy * t2.cumulative_opp_significant_strikes_ground_body_accuracy) AS expected_cumulative_significant_strikes_ground_body_accuracy_diff,        
    ...
    SQRT(t2.avg_significant_strikes_ground_leg_accuracy * t3.avg_opp_significant_strikes_ground_leg_accuracy) - SQRT(t3.avg_significant_strikes_ground_leg_accuracy * t2.avg_opp_significant_strikes_ground_leg_accuracy) AS expected_avg_significant_strikes_ground_leg_accuracy_diff,    
    ...
    SQRT(t2.cumulative_significant_strikes_ground_leg_accuracy * t3.cumulative_opp_significant_strikes_ground_leg_accuracy) - SQRT(t3.cumulative_significant_strikes_ground_leg_accuracy * t2.cumulative_opp_significant_strikes_ground_leg_accuracy) AS expected_cumulative_significant_strikes_ground_leg_accuracy_diff,        
    ...
    SQRT(t2.avg_takedowns_accuracy * t3.avg_opp_takedowns_accuracy) - SQRT(t3.avg_takedowns_accuracy * t2.avg_opp_takedowns_accuracy) AS expected_avg_takedowns_accuracy_diff,    
    t2.cumulative_takedowns_accuracy - t3.cumulative_takedowns_accuracy AS cumulative_takedowns_accuracy_diff,
    SQRT(t2.cumulative_takedowns_accuracy * t3.cumulative_opp_takedowns_accuracy) - SQRT(t3.cumulative_takedowns_accuracy * t2.cumulative_opp_takedowns_accuracy) AS expected_takedowns_accuracy_diff,        
    ...
    SQRT(t2.avg_submissions_accuracy * t3.avg_opp_submissions_accuracy) - SQRT(t3.avg_submissions_accuracy * t2.avg_opp_submissions_accuracy) AS expected_avg_submissions_accuracy_diff,    
    t2.cumulative_submissions_accuracy - t3.cumulative_submissions_accuracy AS cumulative_submissions_accuracy_diff,
    SQRT(t2.cumulative_submissions_accuracy * t3.cumulative_opp_submissions_accuracy) - SQRT(t3.cumulative_submissions_accuracy * t2.cumulative_opp_submissions_accuracy) AS expected_submissions_accuracy_diff,        
